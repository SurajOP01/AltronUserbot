...
if SESSION:
    client = Client(SESSION, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION2:
    client2 = Client(SESSION2, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION3:
    client3 = Client(SESSION3, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION4:
    client4 = Client(SESSION4, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION5:
    client5 = Client(SESSION5, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION6:
    client6 = Client(SESSION6, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION7:
    client7 = Client(SESSION7, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION8:
    client8 = Client(SESSION8, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION9:
    client9 = Client(SESSION9, API_ID, API_HASH, plugins=dict(root="plugins"))
...
if SESSION10:
    client10 = Client(SESSION10, API_ID, API_HASH, plugins=dict(root="plugins"))
